...
html {
    ...
    font-weight: normal;
    line-height: 1.8;
    font-family: "Open Sans", "HelveticaNeue", "Helvetica Neue", Helvetica, Arial, sans-serif; // "Montserrat",
}
...
.main {
    margin-top: var(--width-topbar, 64px);
    /* margin-left: var(--width-sidebar, 268px); */
    padding-top: 40px;
    padding-bottom: 40px;
}
